...
Silex 0.43 est distribué sous forme d'un exécutable autonome. Son utilisation
...
Vous pouvez [examiner le script officiel](https://github.com/Matanek/Silex/blob/v0.43.0/install.sh)
avant de l'exécuter :
