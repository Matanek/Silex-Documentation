...
| Propriété initialisée | `var name:type = value { get { ... } }` |
| Propriété avec setter implicite | `var name:type { get { ... } }` |
| Propriété avec setter explicite | `var name:type { get { ... } set(value) { ... } }` |
